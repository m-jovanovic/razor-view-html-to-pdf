# Convert Razor Views to PDF Reports in ASP.NET Core

I created this sample for my article [Flexible PDF Reporting in .NET Using Razor Views](https://www.milanjovanovic.tech/blog/flexible-pdf-reporting-in-net-using-razor-views).
I suggest reading it to grasp the whole idea.
